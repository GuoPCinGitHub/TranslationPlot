...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://GuoPCinGitHub.github.io/", // 请替换为你的站点URL，以斜杠结尾
...
export const profileConfig: ProfileConfig = {
	avatar: "/assets/home/avatar.jpg", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "糸见纱希",
	...
	links: [
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/GuoPCinGitHub",
		},
		{
			name: "Discord",
			icon: "fa6-brands:discord",
			url: "https://discordapp.com/users/1365243211513073684",
		},
		{
			name: "Twitter",
			icon: "fa6-brands:twitter",
			url: "https://twitter.com/Guo_PC",
		},
		{
			name: "Bluesky",
			icon: "fa6-brands:bluesky",
			url: "https://bsky.app/profile/saki-itomi.bsky.social",
		},
		{
			name: "Steam",
			icon: "fa6-brands:steam",
			url: "https://store.steampowered.com/id/GuoPC/",
		},
	],
};
...
export const announcementConfig: AnnouncementConfig = {
	title: "公告", // 公告标题
	content: "欢迎来到我的歌词翻译小站，随便转转吧～", // 公告内容
